    ...
    <div className="App">
      <header className="App-header">
        ...
        <div className="comment">
          ...
          { titleError ? <><span>Please populate this field</span></> : <></> }
          <div className="flexTitle">
            <textarea id="titleInput" type="text" className="titleInput" onChange={calculateHeight} placeholder="Title..."/>
          </div>
          { inputError ? <span>Please populate this field</span> : <></>}
          <div className="flexInput">
            <textarea id="input" type="text" className="input" onChange={calculateHeight} placeholder="Comment..."/>
          </div>
